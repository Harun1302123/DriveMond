                ...
                <ul class="list-icon">
                    <li>
                        <div class="media gap-2">
                            <img width="18" src="{{asset('assets/admin-module/img/svg/gps.svg')}}" class="svg" alt="">
                            <div class="media-body">{{$trip->coordinate->pickup_address}}</div>
                        </div>
                    </li>
                    <li>
                        <div class="media gap-2">
                            <img width="18" src="{{asset('assets/admin-module/img/svg/map-nav.svg')}}" class="svg" alt="">
                    ...
                    <li>
                        <div class="media gap-2">
                            <img width="18" src="{{asset('assets/admin-module/img/svg/distance.svg')}}" class="svg" alt="">
