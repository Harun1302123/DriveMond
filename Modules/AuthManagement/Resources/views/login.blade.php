    ...
    <div class="login-form d-block">
        <form action="{{ route('admin.auth.login') }}" enctype="multipart/form-data" method="POST"
            ...
            <div class="login-wrap">
                <div class="login-left py-4 d-flex justify-content-center align-items-center bg-center bg-img" data-bg-img="{{asset('assets/admin-module/img/media/login-bg.png')}}">
