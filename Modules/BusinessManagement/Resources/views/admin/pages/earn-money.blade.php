                                    ...
                                    <div class="d-flex">
                                        <div class="upload-file">
                                            ...
                                            <div class="upload-file__img">
                                                <img src="{{ $data1?->value['image'] ? asset('storage/app/public/business/landing-pages/earn-money/'.$data1?->value['image']):asset('assets/admin-module/img/media/upload-file.png') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
