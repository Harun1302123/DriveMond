                                ...
                                <div class="card">
                                    <div class="p-30">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <h3 class="fs-24">{{ $superAdminAccount ? set_currency_symbol($superAdminAccount->received_balance + $superAdminAccount->receivable_balance) : 0 }}</h3>
                                    ...
                                    <div class="p-30">
                                        <div class="d-flex flex-column gap-2">
                                            <div class="level-status fs-5 p-2 bg-success w-48 aspect-1 mb-3">
                                                <img src="{{asset('assets/admin-module/img/svg/revenue.svg')}}"
                                                     class="svg" alt="">
                                            </div>
